...
exports.notificate_new_lesson = function (lessons) {
    async.parallel({
        ...
        let lessonsPeriod;
        if (lessons.length > 1) {
            lessonsPeriod = "Fechas entre: " + lessons[0].getNiceDate(lessons[0].date, 420 * 60 * 1000) + " y " +
                lessons[lessons.length-1].getNiceDate(lessons[lessons.length-1].date, 420 * 60 * 1000);
        } else {
            lessonsPeriod = "Fecha: " + lessons[0].getNiceDate(lessons[0].date, 420 * 60 * 1000);
        }
