...
<a href="localhost:8042/user/recovery?continueProcess=yes&user=` + user.email + `&key=` + hashedKey + `">enlace</a> y asigna una nueva contraseña.
</p>
<p>Si tú no has iniciado este proceso, haz clic <a href="localhost:8042/user/recovery?continueProcess=no&user=` + user.email + `">acá</a> 
